#!/usr/bin/env python3
"""
Claude integration with image2md framework.
...
print("Example: Claude Integration with image2md")
print("=" * 80)
...
#---------------------------------------------------------------------------
# Create a Claude converter class
#---------------------------------------------------------------------------
...
#---------------------------------------------------------------------------
print("\nRegistering Claude converter with Image2MarkdownFactory...")
...
#---------------------------------------------------------------------------
print("\nConverting image using Claude through Image2MarkdownFactory...")
...
print(f"✅ Provenance saved to: {output_dir / 'claude_result.json'}")
