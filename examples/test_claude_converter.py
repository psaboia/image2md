#!/usr/bin/env python3
"""
Test script for Claude converter integration with image2md.
This script tests the ClaudeConverter class and its integration with the Image2MarkdownFactory.
"""
import os
import sys
import unittest
...
# Import image2md components and Claude converter
try:
...
class TestClaudeConverter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.converter = ClaudeConverter(api_key=self.api_key)
    ...
    def test_factory_registration(self):
        ...
        self.assertIn("claude", converters)
        
        # Test that we can get a converter from the factory
        factory_converter = Image2MarkdownFactory.get_converter("claude", api_key=self.api_key)
        self.assertIsInstance(factory_converter, ClaudeConverter)
    ...
    def test_factory_convert_method(self):
        """Test the factory convert method with the Claude converter."""
        # Output paths
    ...
    def test_with_custom_model(self):
        ...
        custom_converter = ClaudeConverter(
            api_key=self.api_key,
